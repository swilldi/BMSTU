...
// Поиск значения с наибольшим ключем одно значение
// Поиск значения с наибольшим ключем
START_TEST(get_min)
{
...
// Поиск значения с наименьшим ключем
START_TEST(get_max)
{
    assoc_array_t arr = assoc_array_create();
    int rc;
...
// Поиск значения с наименьшим ключем, передаются некоректные параметры массива 
...
// Поиск значения с наибольшим ключем, передаются некоректные параметры массива 
...
// Поиск значения с наименьшим ключем, передаются некоректные параметры значения 
...
// Поиск значения с наибольшим ключем, передаются некоректные параметры значения
...
// Поиск значения с наименьшим ключем, массив пустой
...
// Поиск значения с наибольшим ключем, массив пустой
